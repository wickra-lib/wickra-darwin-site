...
- GitHub → the [wickra-darwin repository](https://github.com/wickra-lib/wickra-darwin)
...
Wickra Darwin parses untrusted `ScanSpec` JSON and candle data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-darwin/blob/main/SECURITY.md)
